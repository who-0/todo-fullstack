    ...
    <ul className="m-0 p-1 w-100">
      {lists.map((list) => (
        <li
          ...
          key={list.id}
        >
          <p className="fs-5 m-0 d-inline lists_cs">{list.list}</p>
          <div className="d-inline float-end  pe-1 fs-6 lh-lg">
            <i className="fa-solid fa-pen list-update_cs"></i>
            <i className="fa-regular fa-trash-can ms-2 list-delete_cs"></i>
          </div>
        </li>
      ))}
    </ul>
